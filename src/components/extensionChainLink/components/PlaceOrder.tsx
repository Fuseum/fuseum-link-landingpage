...
export default function PlaceOrder({}: Props) {
    ...
    return (
        <div className="relative flex w-full items-start gap-[10px] font-HelveticaNeue px-3 pb-3">
            {timeOrder && (
                <motion.div
                    initial={{ rotate: 0 }}
                    animate={{ rotate: 360 }}
            ...
            {!timeOrder && <ICCheck />}
            <p className="text-[10px] font-normal not-italic leading-[120%] tracking-[-0.25px] text-[#8A939B] font-Satoshi">
            ...
            {!timeOrder && (
                ...
                >
                    <p className="text-[color:var(--Dark-Gray,#4A465B)] text-base not-italic font-medium leading-[100%] tracking-[-0.25px] text-center">
                        Thank you for using our service!
                    </p>
                    <p className="text-[#82959B] text-sm not-italic font-light leading-[100%] text-center">
